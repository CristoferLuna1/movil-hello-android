...
class DebtNotificationManager(
    ...
    suspend fun checkAndSendDebtNotifications(userId: Int) {
        ...
        val transactions =
            transactionDao
                .getTransactionsByUserAndMonth(userId, currentMonthYear)
                .first()
    ...
    private fun calculateDaysUntilPayment(
        currentDay: Int,
        paymentDay: Int,
        calendar: Calendar
    ): Int {
    ...
    private fun sendDebtNotification(
        ...
        val message = when (daysUntilPayment) {
            ...
            0 ->
                "¡Hoy es el día de pago para: ${transaction.title}!"

            1 ->
                "Mañana es el día de pago para: ${transaction.title}"

            else ->
                "Faltan $daysUntilPayment días para el pago de: ${transaction.title}"
        }
